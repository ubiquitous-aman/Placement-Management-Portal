...
CREATE INDEX IF NOT EXISTS idx_drive_branches_branch ON drive_branches (branch);

COMMENT ON TABLE drive_branches IS 'Eligible branches for each placement drive (1NF decomposition)';
