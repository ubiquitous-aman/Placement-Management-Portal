...
CREATE INDEX IF NOT EXISTS idx_application_rounds_application_id ON application_rounds (application_id);

COMMENT ON TABLE  application_rounds            IS 'Individual recruitment rounds within an application process';
